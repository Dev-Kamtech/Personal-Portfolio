...
// ===== CODE EDITOR TYPING EFFECT (Optional Enhancement) =====
const editorContent = document.querySelector('.editor-content code');
if (editorContent) {
    // Add subtle pulse animation to cursor position
    const lines = editorContent.querySelectorAll('span');
    lines.forEach((line, index) => {
        line.style.opacity = '0';
        line.style.animation = `fade-in-line 0.5s ease-out ${index * 0.05}s forwards`;
    });
}

// Add the fade-in animation dynamically
